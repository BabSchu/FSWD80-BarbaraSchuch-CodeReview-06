...
class Place {
   ...
   img:string;
   createdDate:string;
constructor(name:string, description:string, city:string, zipCode:number, adress:string, adressNr:number, img:string, createdDate:string) {
       this.name = name;
...
class Restaurant extends Place {
   ...
   constructor(name:string, description:string, city:string, zipCode:number, adress:string, adressNr:number, img:string, createdDate:string, telNr:string, webAdress:string, type:string) {
...
class Events extends Place {
   ...
   constructor(name:string, description:string, city:string, zipCode:number, adress:string, adressNr:number, img:string, createdDate:string, eventLocation:string, eventDate:any, eventTime:any, ticketPrice:number) {
       super(name, description, city, zipCode, adress, adressNr, img, createdDate)
...
class StreetArt extends Place {
   ...
   constructor(name:string, description:string, city:string, zipCode:number, adress:string, adressNr:number, img:string, createdDate:string, curator:string, year:number, title:string) {
       super(name, description, city, zipCode, adress, adressNr, img, createdDate)
...
let karlskirche = new Place("Karlskirche","Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1040, "Kreuzherrengasse", 1,"img/places/karlskirche.jpg","Created: 24.10.2019 12:45");
let schlossSchönbrunn = new Place("Schloss Schönbrunn","Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1130, "Schönbrunner Schloßstraße", 47,"img/places/schoenbrunn.jpg",'Created: 23.10.2019 12:45');
let prater = new Place("Schloss Schönbrunn","Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1020, "Prater", 7,"img/places/prater.jpg",'Created: 22.10.2019 12:45');
let hundertwasser = new Place("KUNST HAUS WIEN. Museum Hundertwasser","Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1030, "Untere Weißgerberstraße", 13,"img/places/hundertwasser.jpg","Created: 21.10.2019 12:45");

let harvest = new Restaurant("Harvest", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1020, "Karmeliterplatz", 1, "img/eat/harvest.jpg", "Created: 20.10.2019 12:45","0676 4927790", "http://harvest-bistrot.at/", "https://www.happycow.net/img/category/category_vegan.svg");
let hawidere = new Restaurant("Hawidere", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1150, "Ullmannstraße", 31, "img/eat/hawidere.jpg", "Created: 19.10.2019 12:45", "0664 1508429", "http://hawidere.at/", "https://www.happycow.net/img/category/category_veg-friendly.svg");
let rupps = new Restaurant("Rupps", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1050, "Arbeitergasse", 46, "img/eat/rupps.jpg","Created: 18.10.2019 12:45", "01 5452284", "https://www.rupps.at/", "https://www.happycow.net/img/category/category_vegetarian.svg");
let secretGarden = new Restaurant("Secret Garden", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1060, "Mariahilfer Straße", 45, "img/eat/secretGarden.jpg","Created: 17.10.2019 12:45", "01 5862839", "https://secret-garden-cafe.at/", "https://www.happycow.net/img/category/category_vegetarian.svg");

let cats = new Events ("Cats", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1010, "Seilerstätte", 9,"img/events/cats.jpg","Created: 16.10.2019 12:45", "Ronacher", "13.11.2019", "18.30", 49);
let seeed = new Events ("Seeed", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1150, "Roland-Rainer-Platz", 1,"img/events/seeed.jpg", "Created: 21.10.2019 12:45", "Wiener Stadthalle, Halle D", "1.11.2019", "20.00", 55.80);
let basbaritenori = new Events ("Willi Resetarits & Basbaritenori", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1060, "Mariahilfer Straße", 81,"img/events/basbaritenori.jpg", "Created: 20.10.2019 12:45", "Stadtsaal", "17.12.2019", "20.00", 22.50);
let unspelling = new Events("Unspelled", "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam.", "Vienna", 1070, "Museumsplatz", 1,"img/events/unspelled.jpg", "Created: 22.10.2019 12:45" "TQW Studios", "14.11.2019", "19.30", 15);
...
let kobraKlimt = new StreetArt ("Eduardo Kobra", 
  ...
  "Vienna", 1040, "Wiedner Hauptstraße", 78, "img/StreetArt/kobra_klimt.jpg", "Created: 25.10.2019 12:45", "curated by Calle Libre Festival", 2018, "Untitled" )
...
let nychosFreud = new StreetArt ("Nychos - Rabbit Eye Movement", 
  ...
  "Vienna", 1090, "Spittelauer Lände", 12, "img/StreetArt/nychos_freud.jpg", "Created: 20.10.2019 12:45", "", 2016, "Vienna Therapy - Dissection of Freud" )
...
let skirlRuin = new StreetArt ("skirl and Ruin", 
  ...
  "Vienna", 1020, "Obere Donaustraße", 101, "img/StreetArt/skirl_ruin.jpg", "Created: 29.10.2019 12:45", "", 2017, "Untitled")
...
let cyrcleGaia = new StreetArt ("Cyrcle and Gaia", 
  ...
  "Vienna", 1150, "Felberstraße", 1, "img/StreetArt/cyrcle_gaia.jpg", "Created: 25.10.2019 12:45", "curated by Cash, Cans & Candy", 2014, "Modern Antique")
